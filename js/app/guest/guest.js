...
export const guest = (() => {
     ...
     */
    const countDownDate = () => {
    // Target date: 02 Oktober 2025 pukul 06:00 WIB (UTC+7)
    const count = new Date('2025-10-02T06:00:00+07:00').getTime();
    ...
    const buildGoogleCalendar = () => {
        ...
        const data = new URLSearchParams({
            action: 'TEMPLATE',
            text: 'The Wedding of Eka Zuliana Putri & Galih Kusuma Wardani',
            dates: `${formatDate('2025-10-02 06:00')}/${formatDate('2025-10-02 09:00')}`,
            details: 'Hari & Tanggal : KAMIS, 02 OKTOBER 2025\nPukul : 06.00 WIB\nTempat/Alamat : kediaman mempelai wanita (sambung Gg4 Rt 03 Rw 03 undaan kudus)\nTanpa mengurangi rasa hormat, kami mengundang Anda untuk berkenan menghadiri acara pernikahan kami. Terima kasih atas perhatian dan doa restu Anda, yang menjadi kebahagiaan serta kehormatan besar bagi kami.',
            location: 'kediaman mempelai wanita (sambung Gg4 Rt 03 Rw 03 undaan kudus)',
